...
/**
 * Default {@link SkillToolProviderSpi} providing mock tool definitions and results.
 * <p>
 * Used when no real tool provider is configured (e.g., no OpenAI API key).
 * Tools simulate real skill-review capabilities with predefined responses.
 *
